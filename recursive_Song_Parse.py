...
def build_random_function(min_depth, max_depth, depth = 0):
    """ Builds a random function of depth at least min_depth and depth
        ...
        returns: the randomly generated function represented as a nested listy
                 ...
                 these functions)
    """
    normfuncs = [['cos_pi_x','cos_pi_2','cos_pi_3', 'cos_pi'],['sin_pi_x', 'sin_pi_2', 'sin_pi_3', 'sin_pi'],'e^x',['avg_2','avg_3','avg'],['prod_2','prod_3','prod']]
...
def generate_art(sound_data, num_pics, screen, mindep, maxdep, x_size=350, y_size=350):
    os.system('rm frame*')
...
if __name__ == '__main__':
    ...
    images = generate_art(sound_data, frame_num, screen, mindep, maxdep, x_size, y_size)
